...
CREATE TABLE IF NOT EXISTS atomic.com_urbanairship_uninstall_1 (
...
COMMENT ON TABLE atomic.com_urbanairship_uninstall_1 IS 'iglu:com.urbanairship/UNINSTALL/jsonschema/1-0-0';
