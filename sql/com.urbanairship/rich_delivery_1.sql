...
CREATE TABLE IF NOT EXISTS atomic.com_urbanairship_rich_delivery_1 (
...
COMMENT ON TABLE atomic.com_urbanairship_rich_delivery_1 IS 'iglu:com.urbanairship/RICH_DELIVERY/jsonschema/1-0-0';
