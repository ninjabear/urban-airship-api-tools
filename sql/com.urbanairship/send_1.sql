...
CREATE TABLE IF NOT EXISTS atomic.com_urbanairship_send_1 (
...
COMMENT ON TABLE atomic.com_urbanairship_send_1 IS 'iglu:com.urbanairship/SEND/jsonschema/1-0-0';
