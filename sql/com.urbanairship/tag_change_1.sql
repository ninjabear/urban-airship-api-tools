...
CREATE TABLE IF NOT EXISTS atomic.com_urbanairship_tag_change_1 (
...
COMMENT ON TABLE atomic.com_urbanairship_tag_change_1 IS 'iglu:com.urbanairship/TAG_CHANGE/jsonschema/1-0-0';
